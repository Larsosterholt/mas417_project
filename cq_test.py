...
def generate_stl(user_data_name, user_data_geolocation):
        ...
        text_name = cq.Workplane("XY", origin=(0, 10, 5)).text(user_data_name, 8, 0.2, font="Courier")
        text_geolocation = cq.Workplane("XY", origin=(0, -10, 5)).text(user_data_geolocation, 8, 0.2, font="Courier")
