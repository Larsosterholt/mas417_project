...
class STLGenerator:
    def generate_stl(self, user_data):
        ...
        text_name = cq.Workplane("XY", origin=(0, 10, 1)).text(user_data.name, 8, 0.2, font="Courier")
        text_geolocation = cq.Workplane("XY", origin=(0, -10, 1)).text(user_data.geolocation, 8, 0.2, font="Courier")
        ...
        print(f"STL file generated: name_tag.stl")
